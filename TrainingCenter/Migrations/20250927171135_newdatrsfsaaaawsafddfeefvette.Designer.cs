...
namespace TrainingCenter.Migrations
{
    ...
    [Migration("20250927171135_newdatrsfsaaaawsafddfeefvette")]
    partial class newdatrsfsaaaawsafddfeefvette
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingCenter.Models.CourseAdvance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("courseCodes_Id")
                        .HasColumnType("int");

                    b.Property<int>("stud_course_id")
                        .HasColumnType("int");

                    b.Property<int?>("subjectyapes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainingCenter.Models.CourseFoundational", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("courseFoundationals");
                });

            modelBuilder.Entity("TrainingCenter.Models.Courses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CourseAdvan")
                        .HasColumnType("int");

                    b.Property<int?>("CourseAdvanceId")
                        .HasColumnType("int");

                    b.Property<int?>("CourseFound")
                        .HasColumnType("int");

                    b.Property<int?>("CourseFoundationalId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CourseAdvanceId");

                    b.HasIndex("CourseFoundationalId");
            ...
            modelBuilder.Entity("TrainingCenter.Models.CourseAdvance", b =>
                {
                    b.HasOne("TrainingCenter.Models.CourseCode", "CourseCode")
                        .WithMany()
                        .HasForeignKey("CourseCodeId");

                    b.HasOne("TrainingCenter.Models.StudentCourse", "StudentCourse")
                        .WithMany()
                        .HasForeignKey("StudentCourseId");

                    b.HasOne("TrainingCenter.Models.SubjectType", "SubjectType")
                        .WithMany()
            ...
            modelBuilder.Entity("TrainingCenter.Models.Courses", b =>
                {
                    b.HasOne("TrainingCenter.Models.CourseAdvance", "CourseAdvance")
                        .WithMany()
                        .HasForeignKey("CourseAdvanceId");

                    b.HasOne("TrainingCenter.Models.CourseFoundational", "CourseFoundational")
                        .WithMany()
                        .HasForeignKey("CourseFoundationalId");

                    b.Navigation("CourseAdvance");

                    b.Navigation("CourseFoundational");
                });
